...
predictedOutputData, bestPopulation = utilityGA.tuneTrainPredictConnectivityGA(trainingInputData=trainingInputData,
                                                                               ...
                                                                               horizon=nTesting,
                                                                               noOfBest=noOfBest,
                                                                               resTopology=utilityGA.Topology.ScaleFreeNetworks,
                                                                               size=networkSize,
...
outputFolderName = "Outputs/Scale_Free_Networks_Outputs" + datetime.now().strftime("%Y_%m_%d_%H_%M_%S")
...
utilityGA.storeBestPopulationAndStats(bestPopulation, popFileName, utilityGA.Topology.ScaleFreeNetworks, networkSize)
