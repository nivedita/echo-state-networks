...
# File name for
folderName = "Outputs/GAResults_Scale_Free_Networks_" + datetime.now().strftime("%Y_%m_%d_%H_%M_%S")
os.mkdir(folderName)
...
scatter = plot.ScatterPlot(folderName+fileName, "Scale Free Networks Optimization using GA", "Diameter vs Performance", "Diameter", "Mean Square Error")
...
scatter = plot.ScatterPlot(folderName+fileName, "Scale Free Networks Optimization using GA", "Average Clustering Coefficient vs Performance", "Average Clustering Coefficient", "Mean Square Error")
