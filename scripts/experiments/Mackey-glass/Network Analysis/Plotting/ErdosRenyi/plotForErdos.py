...
# File name for
folderName = "Outputs/GAResults_Erdos_Renyi_" + datetime.now().strftime("%Y_%m_%d_%H_%M_%S")
os.mkdir(folderName)
...
attachmentList = np.array(probabilityList).reshape(len(probabilityList),1)[:,0]
...
scatter = plot.ScatterPlot(folderName+fileName, "Erdos Renyi Networks Optimization using GA", "Probability vs Performance", "Probability", "Mean Square Error")
...
scatter = plot.ScatterPlot(folderName+fileName, "Erdos Renyi Networks Optimization using GA", "Average Degree vs Performance", "Average Degree", "Mean Square Error")
...
scatter = plot.ScatterPlot(folderName+fileName, "Erdos Renyi Networks Optimization using GA", "Average Path Length vs Performance", "Average Path Length", "Mean Square Error")
...
scatter = plot.ScatterPlot(folderName+fileName, "Erdos Renyi Networks Optimization using GA", "Diameter vs Performance", "Diameter", "Mean Square Error")
...
scatter = plot.ScatterPlot(folderName+fileName, "Erdos Renyi Networks Optimization using GA", "Average Clustering Coefficient vs Performance", "Average Clustering Coefficient", "Mean Square Error")
