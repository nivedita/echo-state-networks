...
reservoirWeight = topology.ErdosRenyiTopology(size=size, probability=0.37).generateWeightMatrix()
...
outplot = outputPlot.OutputPlot(outputFolderName + "/Prediction.html", "Mackey-Glass Time Series - Erdos Renyi ESN", "Prediction of Future values", "Time", "Output")
