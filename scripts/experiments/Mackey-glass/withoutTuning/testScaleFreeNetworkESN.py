...
reservoirWeight = topology.ScaleFreeNetworks(size=size, attachmentCount=100).generateWeightMatrix()
...
outplot = outputPlot.OutputPlot(outputFolderName + "/Prediction.html", "Mackey-Glass Time Series - Scale Free Networks ESN", "Prediction of Future values", "Time", "Output")
