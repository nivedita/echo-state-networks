...
# Reservoir-to-reservoir - Small World Graphs
reservoirWeight = topology.SmallWorldGraphs(size=size, meanDegree=50, beta=0.6).generateWeightMatrix()
...
outplot = outputPlot.OutputPlot(outputFolderName + "/Prediction.html", "Mackey-Glass Time Series - Small World Graphs ESN", "Prediction of Future values", "Time", "Output")
