...
inputWeight = topology.RandomInputTopology(inputSize=inputTrainingData.shape[1], reservoirSize=size, inputConnectivity=1.0).generateWeightMatrix()

# Reservoir-to-reservoir 50% connected
reservoirWeight = topology.RandomReservoirTopology(size=size, connectivity=0.92).generateWeightMatrix()
...
outplot = outputPlot.OutputPlot(outputFolderName + "/Prediction.html", "Mackey-Glass Time Series - Random ESN", "Prediction of future values", "Time", "Output")
