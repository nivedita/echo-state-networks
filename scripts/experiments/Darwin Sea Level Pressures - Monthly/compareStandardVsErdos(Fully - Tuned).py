...
esnTuner = tuner.ESNErdosFullTuner(size=size,
...
spectralRadiusOptimum, inputScalingOptimum, reservoirScalingOptimum, leakingRateOptimum, inputWeightConn, reservoirConn = esnTuner.getOptimalParameters()

dummyTopologyObject = topology.ErdosRenyiTopology(size=size, probability=0.5)
...
res = esn.EchoStateNetwork(size=size,
                           ...
                           reservoirTopology=dummyTopologyObject,
