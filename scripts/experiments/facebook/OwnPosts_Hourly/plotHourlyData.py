...
# Read the data
df = pd.read_csv('facebookPosts_timestamp_bmw_time.csv', index_col=0, parse_dates=True, names=['value'])
...
outplot = plotting.OutputTimeSeriesPlot(outputFolderName + "/OwnPosts.html", "Facebook Own posts-BMW", "", "Number of posts")
