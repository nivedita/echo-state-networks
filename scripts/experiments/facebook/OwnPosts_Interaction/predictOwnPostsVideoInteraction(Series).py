...
datasetFileName = "facebookPosts_audi_time_video_interaction.csv"
daysOfHorizon = 4
daysOfDepth = 7
...
util.trainESNWithoutTuning(size=1500, featureVectors=featureTrainingVectors, targetVectors=targetTrainingVectors,
                            ...
                            inputScaling=0.5, reservoirScaling=0.5, spectralRadius=0.79, leakingRate=0.40)
...
util.plotSeries("Outputs/Outputs-Pandas_hourly" + str(datetime.now()) + details,
                [actualSeries, predictedSeries], ["Actual Output", "Predicted Output"], "Facebook Own Posts Video Interaction-Audi", "Video Interaction (Likes+Comments+Shares)")
