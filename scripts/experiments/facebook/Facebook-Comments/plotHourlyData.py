...
# Read the data
df = pd.read_csv('BMW_comments_interaction.csv', index_col=0, parse_dates=True, names=['value'])
...
outplot = plotting.OutputTimeSeriesPlot(outputFolderName + "/OwnPosts.html", "Facebook Comments-BMW", "", "Number of Comments")
